...
import { fetchSunriseSunsetData } from './sunriseSunsetService.js';
import { fetchWorldTimeData } from './worldTimeService.js';
/**
 ...
 */
export async function getCombinedWeatherDataForLocation(lat, lon, unit = 'metric') {
    try {
